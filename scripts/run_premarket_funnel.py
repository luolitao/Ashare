...
from scripts.run_daily_market_indicator import main as run_daily_market_indicator
from scripts.run_index_weekly_channel import main as run_index_weekly_channel
from scripts.run_ma5_ma20_trend_strategy import main as run_ma5_ma20_trend_strategy
